...
<%
	...
	if ( (username != null) && (password != null) ) {
		Enumeration enum = db.getAdmins().elements();
		while (enum.hasMoreElements())
		{
			Admin temp = (Admin)enum.nextElement();
...
<HTML>
<HEAD>
<TITLE>SmartFit: Admin Login</TITLE>
...
<body bgcolor="#99CCFF" link="#3333CC" vlink="#3333CC" alink="#0099FF" leftmargin="0" topmargin="0">
...
<TABLE WIDTH=760 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR> 
    ...
    <TD COLSPAN=2 background="images/pagelayout_04.gif" bgcolor="#99CCFF">&nbsp; </TD>
    <TD> <IMG SRC="images/spacer.gif" WIDTH=1 HEIGHT=62 ALT=""></TD>
  </TR>
  <TR> 
    <TD COLSPAN=4 ROWSPAN=2 bgcolor="#99CCFF"><TABLE BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
        <TR> 
              ...
              <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="boxBorder">
                <tr> 
                  <td><table width="100%" border="0" cellpadding="2" cellspacing="0" align="center" class="tableTop">
                      <tr> 
                        <td bgcolor="#99CCFF" class="largeHeading"> <div align="center">Login</div></td>
                      </tr>
                    </table>
...
<div align="left"></div></td>
    ...
    <TD ROWSPAN=3> <IMG SRC="images/pagelayout_07.gif" WIDTH=45 HEIGHT=418 ALT=""></TD>
    <TD> <IMG SRC="images/spacer.gif" WIDTH=1 HEIGHT=28 ALT=""></TD>
  </TR>
  <TR> 
    <TD> <IMG SRC="images/pagelayout_08.gif" WIDTH=49 HEIGHT=352 ALT=""></TD>
    <TD> <IMG SRC="images/spacer.gif" WIDTH=1 HEIGHT=352 ALT=""></TD>
  </TR>
  <TR> 
    <TD> <IMG SRC="images/pagelayout_09.gif" WIDTH=49 HEIGHT=38 ALT=""></TD>
    <TD COLSPAN=2> <IMG SRC="images/pagelayout_10.gif" WIDTH=207 HEIGHT=38 ALT=""></TD>
    <TD COLSPAN=2> <IMG SRC="images/pagelayout_11.gif" WIDTH=459 HEIGHT=38 ALT=""></TD>
