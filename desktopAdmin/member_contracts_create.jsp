...
<%
	...
	if (action.equals("Submit")) {
		...
		response.sendRedirect("member_contracts_create_confirm.jsp?slots=" + slots + "&time=" + time + "&price=" + price + "&trainerID=" + trainerID);
		return;
	}
    ...
    <tr>
        ...
        <table width="100%" border="0" align="center">
          <tr> 
            ...
            <p align="center">Choose Trainer</td>
          </tr>
          <tr> 
            ...
            <p align="center"><select name="trainerID" size="6">
<%
	Enumeration enum = SMUtils.sortUsers(club.getTrainers()).elements();
	while (enum.hasMoreElements()) {
		Trainer trainer = (Trainer)enum.nextElement();%>
		<option value="<%=trainer.getID()%>"><%=trainer.getFirstName() + " " + trainer.getLastName()%></option>		
<%
	}
%>
              </select></td>
