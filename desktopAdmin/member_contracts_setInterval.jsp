...
<%
    ...
    if (action.equals("View")) {
        ...
        response.sendRedirect("member_contractsMain.jsp");
        return;
    }
    if (action.equals("Create New Contract")) {
    	response.sendRedirect("member_contracts_create.jsp");
    	return;
    }
%>
<%
...
<form name="form1" method="post" action="member_contracts_setInterval.jsp">
    ...
    <tr>
          ...
          <tr> 
            <td bgcolor="#99CCFF" class="largeHeading"> <div align="center">Set 
                Interval to View Contracts for Client <%=client.getFirstName() + " " + client.getLastName()%></div>
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="0" class="dashedOnTop">
          <tr> 
            <td> <div align="left">
                <input type="submit" name="action" value="Create New Contract">
              </div></td>
            <td><div align="right">
