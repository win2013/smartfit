...
<%
    ...
    while (routines.hasMoreElements()) {
        ...
        <tr class="largeHeading" bgcolor="#99CCFF">           
          <td bgcolor="#99CCFF" colspan="4"><p bgcolor="#99CCFF" align="center"><%=routine.getName()%></p></td>          
        </tr>
        </table>
<%
...
<table width="100%" border="0" cellpadding="2" cellspacing="0">
  <tr class="largeHeading" bgcolor="#99CCFF"> 
    <td colspan="3" bgcolor="#99CCFF"><%=exercise.getName()%></td>
    <td bgcolor="#99CCFF">&nbsp;</td>
  </tr>
  <%
            if (exercise instanceof AerobicExercise) {%>
  <tr bgcolor="#99CCFF" class="largeHeading"> 
    <td bgcolor="#99CCFF" width="25%">Set #</td>
    <td bgcolor="#99CCFF" width="25%">Intensity</td>
    <td bgcolor="#99CCFF" width="25%">Time (min)</td>
    <td bgcolor="#99CCFF" width="25%"><div align="left"></div></td>
  </tr>
  <%
