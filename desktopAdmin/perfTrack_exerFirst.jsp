...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="boxBorder">
  <tr> 
    <td><table width="100%" border="0" cellpadding="2" cellspacing="0" class="tableTop">
        <tr> 
          <td bgcolor="#99CCFF"> <div align="center" class="largeHeading">The 
              Following Exercises Were Performed From <%=SMUtils.parseDate(startTime) + " to " + SMUtils.parseDate(endTime)%></div></td>
        </tr>
      </table>
...
<%
    ...
    while (keys.hasMoreElements()) {
        ...
        <tr> 
          <td width="50%" bgcolor="#<%=( (count%2==0) ?"C7E1E9" :"FFFFFF")%>" class="normalText"><a href="perfTrack_exerFirst_detail.jsp?exerciseName=<%=exerciseName%>&exerciseType=<%=info[0]%>&sets=<%=info[2]%>"><%=exerciseName%></a></td>
