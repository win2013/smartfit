...
<%
            ...
            javax.imageio.ImageIO.write(image, "jpg", new java.io.File("c:\\tomcat\\webapps\\smartfit\\desktopAdmin\\temp\\" + filename));
%>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="boxBorder">
  <tr> 
    <td><table width="100%" border="0" cellpadding="2" cellspacing="0" class="tableTop">
        <tr> 
          <td bgcolor="#99CCFF"> <div align="center" class="largeHeading">Exercise 
              Info for &lt;date&gt; through &lt;date&gt;</div></td>
        </tr>
      </table>
