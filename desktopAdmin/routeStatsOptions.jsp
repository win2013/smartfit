...
<%
	try {
        ...
        if (desiredStats.equals("newClients"))  {
		    response.sendRedirect("stats_newPeople.jsp");
			}
		if (desiredStats.equals("lostContracts"))  {
		    response.sendRedirect("stats_lostContracts.jsp");
			}
		if (desiredStats.equals("resignedContracts"))  {
		    response.sendRedirect("stats_resignedContracts.jsp");
			}
		if (desiredStats.equals("inactiveContracts"))  {
		    response.sendRedirect("stats_inactiveContracts.jsp");
			}
              return;
	    }
