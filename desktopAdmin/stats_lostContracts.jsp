  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="boxBorder">
    <tr> 
      <td><table width="100%" border="0" cellpadding="2" cellspacing="0" align="center" class="tableTop">
          <tr> 
            <td bgcolor="#99CCFF" class="largeHeading"> <div align="center">Lost 
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            <td class="largeHeading">Total Lost Contracts:</td>
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0">
          <tr bgcolor="#FFFFFF"> 
            ...
            <td width="20%" class="largeHeading">Date Last Contract Signed</td>
