  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="boxBorder">
    <tr> 
      <td><table width="100%" border="0" cellpadding="2" cellspacing="0" align="center" class="tableTop">
          <tr> 
            <td bgcolor="#99CCFF" class="largeHeading"> <div align="center">New 
                Clients for <%=club.getName()%> between <%=SMUtils.parseDate(startTime)%> and <%=SMUtils.parseDate(endTime)%></div></td>
          </tr>
        </table>
        <table width="100%" border="0" cellspacing="0" cellpadding="3">
          <tr>
            <td class="largeHeading">Total New Clients:</td>

          </tr>
        </table>
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0">
          <tr bgcolor="#FFFFFF"> 
            <td width="40%" class="largeHeading">Name</td>
            <td width="20%" class="largeHeading">Date Contract Signed</td>
            <td width="40%" class="largeHeading">Trainer</td>
          </tr>
          <%
...
%>
          <tr class="normalText" bgcolor="<%= ( (count++%2==0) ?"#C7E1E9" :"#FFFFFF")%>"> 
            ...
            <td width="40%"><%=trainer.getFirstName() + " " + trainer.getLastName()%></td>
            <%
    }
%>
        </table></td>
