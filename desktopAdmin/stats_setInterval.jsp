...
<form name="mainForm" method="post" action="routeStatsOptions.jsp">
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="boxBorder">
    <tr>
          ...
          <tr> 
            <td bgcolor="#99CCFF" class="largeHeading"> <div align="center">Set 
                Interval to View Statistics</div>
              ...
              <table width="100%" border="0" align="center">
               ...
               <tr class="largeHeading"> 
                  ...
                  <td width="10%">Year</td>
                  <td width="22%"> <input name="startYear" type="text" size="4" maxlength="4" value="<%=year%>"></td>
                </tr>
                <tr> 
                ...
                <tr class="largeHeading"> 
                  ...
                  <td>Year</td>
                  <td> <input name="endYear" type="text" size="4" maxlength="4" value="<%=year%>"></td>
                </tr>
              </table>
              
        <table width="100%" border="0" cellpadding="2" cellspacing="0" class="dashedOnTop">
          <tr>
            <td class="largeHeading">View Statistics On: 
              <select name="desiredStats">
                <option value="trainerLogs" selected>Trainer Logs</option>
                <option value="newClients">New Clients</option>
                <option value="lostContracts">Lost Contracts</option>
                <option value="resignedContracts">Resigned Contracts</option>
                <option value="inactiveContracts">Inactive Contracts</option>
              </select></td>
          </tr>
        </table>
        <table width="100%" border="0" cellpadding="2" cellspacing="0" class="dashedOnTop">
