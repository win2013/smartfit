...
<%
    ...
    if (setDay != null) {
        ...
        response.sendRedirect("trainer_contractsMain.jsp");
        return;
    }
%>
<%
...
<form name="form1" method="post" action="trainer_contracts_setInterval.jsp">
    ...
    <tr>
          ...
          <tr> 
            <td bgcolor="#99CCFF" class="largeHeading"> <div align="center">Set 
                Interval to View Contracts for Trainer <%=trainer.getFirstName() + " " + trainer.getLastName()%></div>
