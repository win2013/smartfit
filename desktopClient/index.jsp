...
<%
	...
	if ( (username != null) && (password != null) ) {
		...
		{
			Client temp = (Client)enum.nextElement();
...
<BODY BGCOLOR=#CCCCFF link="#3333CC" vlink="#3333CC" alink="#0099FF" LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0>
...
<TABLE WIDTH=760 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  ...
  <TR> 
    <TD COLSPAN=4 ROWSPAN=2 bgcolor="#CCCCFF"><table border=0 align="center" cellpadding=0 cellspacing=0>
        <tr> 
              ...
              <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="boxBorder">
                <tr> 
                  <td><table width="100%" border="0" cellpadding="2" cellspacing="0" align="center" class="tableTop">
                      <tr> 
                        <td bgcolor="#CCCCFF" class="largeHeading"> <div align="center">Login</div></td>
                      </tr>
                    </table>
