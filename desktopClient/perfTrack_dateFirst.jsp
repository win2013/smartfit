...
%>
        <tr bgcolor="#<%= (( (count++%2==0) ?"C7E1E9" :"FFFFFF"))%>"> 
          <td width="30%"  class="normalText"><a href="../trainerModule/perfTrack_dateFirst_detail.jsp?workoutSessionID=<%=ws.getID()%>"><%=month + "/" + day + "/" + year + "  " + time%></a></td>
          <td width="45%" class="normalText"><%=routines%></td>
          <td class="normalText"><div align="left"></div>
            <%=totalExercises%></td>
        </tr>
<%
