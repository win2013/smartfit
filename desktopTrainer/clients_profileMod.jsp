...
<%
	...
	if (action == null) 
        ...
        if (action.equals("update")) {
            ...
            response.sendRedirect("clients_profileMain.jsp");
            return;
        }
...
<form name="form1" method="post" action="clients_profileMod.jsp?action=update">
      ...
      <td><table width="100%" border="0" cellpadding="2" cellspacing="0" align="center" class="tableTop">
        ...
        <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" height="361">
          ...
          <tr> 
            ...
            <td colspan="2" class="normalText" height="20"> <input type="radio" name="radiobutton" value="male" <%=( (client.getMale()) ?"checked" :"")%>>
              Male 
