...
<%
	...
	if (muscleGroup == null)
        ...
        if (action.equals("deleteExercise")) {
            ...
            if (exercise != null)
                trainer.removeExercise(exercise);
	}
...
<%
	...
	%>httpLink = "exercises_view.jsp?exerciseType=" + mainForm.exerciseType.value + "&muscleGroup=" + mainForm.muscleGroup.value;<%
    }
    else {
	%>httpLink = "exercises_view.jsp?exerciseType=" + mainForm.exerciseType.value;<%
    }
%>
	window.location = httpLink;
}
      ...
      <td><table width="100%" border="0" cellpadding="2" cellspacing="0" align="center" class="tableTop">
          <tr> 
            <td bgcolor="#FFCC66" class="largeHeading"> 
              <div align="center">Exercises for <%=trainer.getFirstName() + " " + trainer.getLastName()%></div></td>
          </tr>
        </table>
          ...
          <tr>
            <td><table width="100%" border="0" cellpadding="2" cellspacing="0" class="normalText">
                <tr class="largeHeading"> 
                  ...
                  <td width="33%"> 
                    <div align="center"><a href="exercises_create.jsp">Create</a></div>
                    <div align="center"></div></td>
                  <td width="33%"> 
                    <div align="center"><a href="exercises_import.jsp">Import</a></div></td>
                </tr>
              </table>
