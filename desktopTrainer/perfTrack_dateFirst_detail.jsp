...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="boxBorder">
  <tr>
    <td><table width="100%" border="0" cellpadding="2" cellspacing="0" class="tableTop">
        <tr>
                <td bgcolor="#FFCC66"> <div align="center" class="largeHeading">Workout 
              Session Info for <%=SMUtils.parseDateAndTime(ws.getStartTime())%></div>           </td>
            </tr>
        </table>
      <%
    ...
    while (routines.hasMoreElements()) {
        ...
        <tr class="largeHeading" bgcolor="#FFCC66">           
          <td bgcolor="#FFCC66" colspan="4"><p bgcolor="#FFCC66" align="center"><%=routine.getName()%></p></td>          
        </tr>
        </table>
<%
...
<table width="100%" border="0" cellpadding="2" cellspacing="0">
  <tr class="largeHeading" bgcolor="#FFCC66"> 
    <td colspan="3" bgcolor="#FFCC66"><%=exercise.getName()%></td>
    <td bgcolor="#FFCC66">&nbsp;</td>
  </tr>
  <%
            if (exercise instanceof AerobicExercise) {%>
  <tr bgcolor="#FFCC66" class="largeHeading"> 
    <td bgcolor="#FFCC66" width="25%">Set #</td>
    <td bgcolor="#FFCC66" width="25%">Intensity</td>
    <td bgcolor="#FFCC66" width="25%">Time (min)</td>
    <td bgcolor="#FFCC66" width="25%"><div align="left"></div></td>
  </tr>
  <%
...
<%
                ...
                <tr bgcolor="#FFCC66" class="largeHeading"> 
                  ...
                  <td width="25%"><div align="left">Rest Time</div></td>
                </tr>
<%
