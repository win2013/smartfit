...
<%
    ...
    if (routineID != null) {
        ...
        routine = trainer.getRoutine(id);
        session.setAttribute("routine", routine);
    }

    if (action.equals("removeExercise")) {
        Exercise exercise = (Exercise)routine.getExercise(Integer.parseInt(exerciseID));
...
function remove()
{
    httpLink = 'routines_modify_trainer.jsp?action=removeExercise&exerciseID=' + mainForm.exerciseID.value;
    ...
    <tr> 
      <td><table width="100%" border="0" cellpadding="2" cellspacing="0" align="center" class="tableTop">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr> 
            <td><div align="center">
                <select name="exerciseID" size="16">
<%
          ...
          <tr> 
            <td><table width="100%" border="0" cellpadding="2" cellspacing="0" class="normalText">
                <tr> 
                  ...
                  <td width="33%">
<div align="center"><a href="javascript:remove()">Remove Exercise</a></div></td>
                  <td width="33%">
