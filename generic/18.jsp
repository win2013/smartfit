...
sf.users.Admin object = null;
String ID = request.getParameter("ID");
if (ID != null) {
object = (sf.users.Admin)db.getAdmin(Integer.parseInt(ID));
session.setAttribute("object", object);
}
object = (sf.users.Admin)session.getAttribute("object");
%>
<%
...
%>
<html>
<title>JSP Interface For Object:  Admin</title>
<script>
...
<form name="mainForm" METHOD="POST" action="18.jsp?action=updatePrimitives">
<p>Parent Fields</p>
<p>Primitives</p>
