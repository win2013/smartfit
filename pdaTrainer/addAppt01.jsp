...
%>
<%
	Enumeration enum = trainer.getClients().elements();
%>
<html>
<head>
...
{
	clientID = members.member.value;
	genericName = members.generic.value;	
	httpLink = httpLink + '&clientID=' + clientID + '&generic=' + genericName;
   ...
   <td rowspan="2"><img name="pda2_r6_c1" src="images/pda2_r6_c1.gif" width="8" height="226" border="0" alt=""></td>
	...
	<form name="members">
        <table width="90%" border="0" align="center" cellpadding="1" cellspacing="1">
          <tr> 
            <td colspan="2" class="sectionText"><strong><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Add 
              Appointment </font></strong></td>
          </tr>
          <tr> 
            <td colspan="2" class="sectionText"><strong><font size="1" face="Arial, Helvetica, sans-serif">Select 
              A Member</font></strong></td>
          </tr>
          <tr> 
            <td colspan="2"><strong><font face="Arial, Helvetica, sans-serif"> 
              <select name="member" size="4">
                <%
                  		while (enum.hasMoreElements())
                  		{
                  			Client c = (Client)enum.nextElement();
                  			out.println("<option value=\"" + c.getID() + "\">" + c.getFirstName() + " " + c.getLastName() + "</option>");
                  		}
                  %>
              </select>
              </font></strong> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td><div align="center"> <a href="javascript:forward('addAppt02.jsp?generic=no')"> 
                      <img src="buttons/addMemAppt.gif" width="139" height="19" border="0"></a></div></td>
                </tr>
              </table></td>
          </tr>
          <tr>
          ...
          <tr> 
            <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong>Add 
              A Non-Member Appointment</strong></font></td>
          </tr>
          <tr> 
            <td width="51%"><strong><font size="1" face="Arial, Helvetica, sans-serif">Appt. 
              Name</font></strong></td>
            <td width="49%"> <input name="generic" type="text" size="12" maxlength="12"></td>
          </tr>
          <tr> 
            <td colspan="2"><div align="center"><strong> <a href="javascript:forward('addAppt02.jsp?generic=yes')"> 
                <img src="buttons/addOtherAppt.gif" width="133" height="19" border="0"></a></strong></div></td>
          </tr>
        </table>
	  </form>
	  </td>
