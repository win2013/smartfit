...
<!-- fwtable fwsrc="newPDADesign.png" fwbase="pda2.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
  ...
  <tr>
   <td rowspan="2"><img name="pda2_r6_c1" src="images/pda2_r6_c1.gif" width="8" height="226" border="0" alt=""></td>
    <td colspan="4" valign="top"><p class="sectionText"><font size="1" face="Arial, Helvetica, sans-serif"></font></p>
      <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><font size="1" face="Arial, Helvetica, sans-serif"><strong>Click 
            A Day To See Daily Planner</strong></font></td>
        </tr>
      </table>
      ...
      <table width="94%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
        <tr class="calendarDay"> 
          <td><div align="left"><font color="#0066CC" size="1" face="Arial, Helvetica, sans-serif"><a href="calendarView.jsp?month=<%=(month-1)%>&year=<%=year%>"><img src="buttons/prevMonth.gif" width="92" height="19" border="0"></a></font></div></td>
          <td> <div align="right"><a href="calendarView.jsp?month=<%=(month+1)%>&year=<%=year%>"><img src="buttons/nextMonth.gif" width="70" height="19" border="0"></a></div></td>
        </tr>
      </table>
      </td>
