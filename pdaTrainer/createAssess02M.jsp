...
<!-- fwtable fwsrc="newPDADesign.png" fwbase="pda2.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
  ...
  <tr>
   <td rowspan="2"><img name="pda2_r6_c1" src="images/pda2_r6_c1.gif" width="8" height="226" border="0" alt=""></td>
	...
	<form method="post" action="setAssess02M.jsp">
	<table width="90%" border="0" align="center" cellpadding="1" cellspacing="0">
        ...
        <tr> 
          <td><font size="1" face="Arial, Helvetica, sans-serif"><strong>Pectoralis 
            (Chest)</strong></font></td>
          <td><div align="right"> 
              <input name="pecA" type="text" size="3" maxlength="3">
              / 
              <input name="pecB" type="text" size="3" maxlength="3">
            </div></td>
        </tr>
        <tr> 
          <td><font size="1" face="Arial, Helvetica, sans-serif"><strong>Abdominal</strong></font></td>
          <td> <div align="right"> 
              <input name="abA" type="text" size="3" maxlength="3">
              / 
              <input name="abB" type="text" size="3" maxlength="3">
            </div></td>
        </tr>
        <tr> 
