...
<%
	...
	a.sar = request.getParameter("sit");
	a.flexCat = request.getParameter("catA");
	a.flexGirdle[0] = request.getParameter("L");
	a.flexGirdle[1] = request.getParameter("R");
	a.flexCat2 = request.getParameter("catB");
...
<!-- fwtable fwsrc="newPDADesign.png" fwbase="pda2.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
  ...
  <tr>
   <td rowspan="2"><img name="pda2_r6_c1" src="images/pda2_r6_c1.gif" width="8" height="226" border="0" alt=""></td>
	...
	<form method="submit" action="setAssess05.jsp">
	    <table width="90%" border="0" align="center" cellpadding="1" cellspacing="0">
          <tr> 
            <td colspan="2"><strong><font size="2" face="Arial, Helvetica, sans-serif">Strength 
              Assessment </font></strong></td>
          </tr>
          <tr> 
            <td colspan="2"><strong><font size="1" face="Arial, Helvetica, sans-serif">Leg 
              Press:</font></strong> <div align="right"><font size="1" face="Arial, Helvetica, sans-serif"><strong> 
                </strong></font></div></td>
          </tr>
          <tr> 
            <td><strong><font size="1" face="Arial, Helvetica, sans-serif">Absolute 
              <input name="abs" type="text" size="3" maxlength="3">
              </font></strong></td>
            <td><div align="right"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font size="1" face="Arial, Helvetica, sans-serif"><strong>Relative 
                <input name="rel" type="text" size="3" maxlength="3">
                </strong></font> </strong></font></div></td>
          </tr>
          <tr> 
            <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong>Category 
              <input name="catA" type="text" size="18" maxlength="18">
              </strong></font></td>
          </tr>
          <tr> 
            <td colspan="2"><strong><font size="1" face="Arial, Helvetica, sans-serif">Chest 
              Press:</font></strong> 
              <div align="right"><strong><font size="1" face="Arial, Helvetica, sans-serif"> 
                </font></strong></div></td>
          </tr>
          <tr> 
            <td><strong><font size="1" face="Arial, Helvetica, sans-serif">Absolute 
              <input name="absA" type="text" size="3" maxlength="3">
              </font></strong></td>
            <td><div align="right"><strong><font size="1" face="Arial, Helvetica, sans-serif"><strong>Relative 
                <input name="relB" type="text" size="3" maxlength="3">
                </strong> </font></strong></div></td>
          </tr>
          <tr> 
            <td colspan="2"><strong><font size="1" face="Arial, Helvetica, sans-serif">Category 
              <input name="catB" type="text" size="18" maxlength="18">
              </font></strong></td>
          </tr>
          <tr> 
            <td colspan="2"><div align="right"><input type="image" img src="buttons/finish.gif" width="43" height="19" border="0"></div></td>
          </tr>
        </table> 
	  </form>
	  </td>
