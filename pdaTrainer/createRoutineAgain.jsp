...
<%
	Routine routine = (Routine)session.getValue("routine");
	String id = request.getParameter("routineID");
	if (id != null)
	{
		if (client != null)
			routine = client.getRoutine(Integer.parseInt(id));
		else
			routine = trainer.getRoutine(Integer.parseInt(id));
...
<table border="0" cellpadding="0" cellspacing="0" width="226">
  ...
  <tr> 
    ...
    <td colspan="4" valign="top"><form name="routines" method="post" action="">
        <table width="90%" height="50%" border="0" align="center" cellpadding="1" cellspacing="0">
          <tr> 
            <td class="sectionText"><strong><font size="1" face="Arial, Helvetica, sans-serif">Routine Name: <%=routine.getName()%></font></strong></td>
          </tr>
          <tr> 
            <td class="sectionText"><strong><font size="1" face="Arial, Helvetica, sans-serif">Current 
              Exercises:</font></strong></td>
          </tr>
        </table>
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center"><select name="routine" size="8">
                <%

                  	Iterator i = routine.getExercises().iterator();
                  			
                  	while (i.hasNext())
                  	{
                  		Exercise excercise = (Exercise)i.next();
                  		out.println("<option value=\"" + excercise.getID() + "\">" + excercise.getName() + "</option>");
                  	}
                  %>
              </select>
              <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td width="33%"> <div align="center"><a href="createRoutine02.jsp?add=true"><img src="buttons/add.gif" width="29" height="19" border="0"></a></div></td>
                  <td><div align="center"> <a href="javascript:forward('removeExcercise.jsp')"><img src="buttons/remove.gif" width="47" height="19" border="0"></a></div></td>
                  <%
                  	String routineLink = "routinesMain.jsp";
                  	if (client != null)
                  		routineLink = "memberRoutines.jsp";
                  %>
                  <td width="33%"> <div align="center"><a href="<%=routineLink%>"><img src="buttons/finish.gif" width="43" height="19" border="0"></a></div></td>
                </tr>
              </table></td>
          </tr>
        </table>
