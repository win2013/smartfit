        ...
        <table width="95%" border="0" align="center" cellpadding="1" cellspacing="1">
          <tr> 
            <td class="sectionText"> <p><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"><strong>Choose 
                A Flexebility Exercise</strong></font></p></td>
          </tr>
          <tr> 
            <td><select name="excerciseID" size="8">
                <%
                  		Vector excercises = club.getAerobicExcercises();
                  		Iterator i = excercises.iterator();
                  		while (i.hasNext())
                  		{
                  			Excercise excercise = (Excercise)i.next();
