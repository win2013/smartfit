...
<%
	Iterator  i = trainer.getRoutines().iterator();
%>
<%
...
{
	routineID = document.routines.routine.value;
	httpLink = httpLink + '?routineID=' + routineID;
...
<!-- fwtable fwsrc="newPDADesign.png" fwbase="pda2.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
  ...
  <tr>
   <td rowspan="3" colspan="2"><img name="pda2_r3_c1" src="images/pda2_r3_c1.gif" width="12" height="18" border="0" alt=""></td>
    <td rowspan="2" bgcolor="#CCCCFF"><strong><font size="1" face="Arial, Helvetica, sans-serif">Routines</font></strong></td>
...
<form name="routines" method="post" action="">
          ...
          <tr valign="top"> 
            <td height="166"> <div align="center"><strong><font color="#999999" size="2"> 
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    <td><strong>
                    <a href="javascript:forward('addGenericRoutine.jsp')"><img src="buttons/add.gif" width="29" height="19" border="0"></a></strong></td>
                    <td><strong><font color="#999999" size="2"></font></strong> 
                      <div align="right"><strong><a href="memberRoutines.jsp"><img src="buttons/back.gif" width="35" height="19" border="0"></a></strong></div></td>
                  </tr>
                </table>
