...
<!-- fwtable fwsrc="newPDADesign.png" fwbase="pda2.gif" fwstyle="Dreamweaver" fwdocid = "742308039" fwnested="0" -->
  ...
  <tr>
    ...
    <td colspan="4" valign="top"><table width="90%" border="0" align="center" cellpadding="1" cellspacing="0">
        <tr> 
          <td><font size="2" face="Arial, Helvetica, sans-serif"><strong>To View 
            Confidential Note Enter Password</strong></font></td>
        </tr>
      </table> 
      <form action="noteDetail.jsp?id=<%=id%>" method="POST" name="mainForm">
      <table width="90%" border="0" align="center" cellpadding="1" cellspacing="1">
        ...
        <tr> 
          <td>
          <input type="image" src="buttons/submit.gif" value="Submit" name="B1" width="45" height="19"></td>
          <td><div align="right"><a href="viewNotes.jsp"><img src="buttons/cancel.gif" width="47" height="19" border="0"></a> 
            </div></td>
        </tr>
      </table>
      </form>
