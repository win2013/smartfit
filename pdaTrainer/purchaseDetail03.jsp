...
<form name="routinesForm" method="post" action="">
        <table width="90%" border="0" align="center" cellpadding="1" cellspacing="1">
          <tr> 
            <td height="16" colspan="2" class="sectionText"><strong><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Purchase 
              Confirmation </font></strong></td>
          </tr>
          <tr valign="top"> 
            <td height="13" colspan="2"> <div align="left"><strong><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">(service/program 
                name)</font></strong></div></td>
          </tr>
          <tr valign="top"> 
            <td colspan="2" valign="top"><div align="left"><strong><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">(Member) 
                has selected (service/program name) for (time) on (date).</font></strong></div></td>
          </tr>
          <tr valign="top">
            <td colspan="2" valign="top"><font size="1" face="Arial, Helvetica, sans-serif"><strong>Price: </strong></font></td>
          </tr>
          <tr valign="top"> 
            <td valign="top"><div align="center"><img src="buttons/purchase.gif" width="59" height="19"></div></td>
