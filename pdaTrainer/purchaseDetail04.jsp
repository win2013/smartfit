...
<form name="routinesForm" method="post" action="">
        <table width="90%" border="0" align="center" cellpadding="1" cellspacing="0">
          <tr> 
            <td colspan="2" class="sectionText"> <div align="left"><strong><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Purchase 
                Completed </font></strong></div></td>
          </tr>
          <tr valign="top"> 
            <td colspan="2" valign="top"><div align="left"><strong><font color="#000000" size="1" face="Arial, Helvetica, sans-serif">(Member) 
                has purchased (service/program name) for (time) on (date).</font></strong></div>
              </td>
          </tr>
          <tr valign="top"> 
            <td valign="top"><div align="center"><img src="buttons/finish.gif" width="43" height="19"></div></td>
