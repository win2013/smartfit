...
<%
	Iterator i = club.getPrograms().iterator();
%>
<%
...
{
	programID = document.programs.program.value;
	httpLink = httpLink + '?programID=' + programID;
...
<form name="programs" method="post" action="">
        <table width="90%" border="0" align="center" cellpadding="1" cellspacing="0" height="200">
          <tr> 
            <td class="sectionText" height="16"><strong><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Select 
              A Program</font></strong></td>
          </tr>
          <tr valign="top"> 
            <td height="166"> <div align="center"><strong><font color="#999999" size="2"> 
                <select name="program" size="10" id="services">
                  <%
                  		while (i.hasNext())
                  		{
                ...
                <br>
                <a href="javascript:forward('purchaseDetail01.jsp')">
                <img src="buttons/select.gif" width="47" height="19" border="0"></a> <br>
                </font></strong></div></td>
          </tr>
        </table>
            </form></td>
