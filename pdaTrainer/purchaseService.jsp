...
<%
	Iterator i = club.getServices().iterator();
%>
<%
...
<form name="services" method="post" action="">
        <table width="90%" border="0" align="center" cellpadding="1" cellspacing="0" height="200">
          <tr> 
            <td class="sectionText" height="16"><strong><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">Select 
              A Service</font></strong></td>
          </tr>
          <tr valign="top"> 
            <td height="166"> <div align="center"><strong><font color="#999999" size="2"> 
                <select name="service" size="10" id="services">
                  <%
                  		while (i.hasNext())
                  		{
                ...
                <table width="90%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td><strong><font color="#999999" size="2"><img src="buttons/select.gif" width="47" height="19"></font></strong></td>
                    <td><div align="right"><a href="purchaseSelect.jsp"><img src="buttons/back.gif" width="35" height="19" border="0"></a></div></td>
                  </tr>
                </table>
