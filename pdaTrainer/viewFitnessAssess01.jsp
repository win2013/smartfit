...
<%
	...
	String fitnessAssessLink = "viewFitnessAssess02" + sex + ".jsp";	
%>
<html>
<head>
   ...
   <td rowspan="2"><img name="pda2_r6_c1" src="images/pda2_r6_c1.gif" width="8" height="226" border="0" alt=""></td>
    <td colspan="4" valign="top"><table width="90%" border="0" align="center" cellpadding="1" cellspacing="0">
        ...
        <tr> 
          ...
          <td> <div align="right"><font size="1" face="Arial, Helvetica, sans-serif">Sex: <%=sex%></font></div></td>
        </tr>
        <tr bgcolor="#3366CC"> 
          <td colspan="2"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Resting 
            Measurements</font></strong></td>
        </tr>
        <tr> 
          <td width="61%"><font size="1" face="Arial, Helvetica, sans-serif"><strong>Height:</strong><%=client.getHeight()[0]%>'<%=client.getHeight()[1] + "''"%></font></td>
          <td width="31%"> <div align="right"><font size="1" face="Arial, Helvetica, sans-serif"><strong>Weight:</strong> <%=client.getWeight()%></font></div></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong>Workout 
            Phase:</strong> <%=client.getWorkoutPhase()%></font></td>
        </tr>
        <tr> 
          <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong>Profile 
            Last Updated:</strong> <%=date%></font></td>
        </tr>
        <tr> 
          <td><div align="left"></div></td>
          <td><div align="right"><a href="<%=fitnessAssessLink%>"><img src="buttons/next.gif" width="35" height="19" border="0"></a></div></td>
        </tr>
      </table> </td>
