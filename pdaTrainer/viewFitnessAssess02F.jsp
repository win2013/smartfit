  ...
  <tr>
   <td rowspan="2"><img name="pda2_r6_c1" src="images/pda2_r6_c1.gif" width="8" height="226" border="0" alt=""></td>
    <td colspan="4" valign="top"><table width="90%" border="0" align="center" cellpadding="1" cellspacing="0">
        ...
        <tr> 
          <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif">Tricep: <%=a.tricep[0] + "/" + a.tricep[1]%>
            </font></td>
        </tr>
        <tr> 
          <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong>Suprailiac: <%=a.sup[0] + "/" + a.sup[1]%>
            </strong></font></td>
        </tr>
        <tr> 
          <td colspan="2"><strong><font size="1" face="Arial, Helvetica, sans-serif">Thigh: <%=a.femaleThigh[0] + "/" + a.femaleThigh[1]%>
            </font></strong></td>
        </tr>
        <tr> 
          <td colspan="2"><strong><font size="1" face="Arial, Helvetica, sans-serif">Total 
            % Body Fat:  <%=a.total[0] + "/" + a.total[1]%></font></strong></td>
        </tr>
        <tr> 
          <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong>Category: <%=a.femCat%>
            </strong></font></td>
        </tr>
        <tr> 
