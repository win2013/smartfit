  ...
  <tr>
   <td rowspan="2"><img name="pda2_r6_c1" src="images/pda2_r6_c1.gif" width="8" height="226" border="0" alt=""></td>
    <td colspan="4" valign="top"><table width="90%" border="0" align="center" cellpadding="1" cellspacing="0">
        <tr bgcolor="#3366CC"> 
          <td colspan="2"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>Strength 
            Assessment </strong></font></td>
        </tr>
        <tr> 
          <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif">Leg 
            Press: </font></td>
        </tr>
        <tr> 
          <td width="50%"><strong><font size="1" face="Arial, Helvetica, sans-serif">Absolute:  <%=a.legPress[0]%></font></strong></td>
          <td><strong><font size="1" face="Arial, Helvetica, sans-serif">Relative:  <%=a.legPress[1]%></font></strong></td>
        </tr>
        <tr> 
          <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong>Category: 
              <%=a.legPress[2]%></strong></font></td>
        </tr>
        <tr> 
          <td colspan="2"><strong><font size="1" face="Arial, Helvetica, sans-serif">Chest 
            Press: </font></strong></td>
        </tr>
        <tr> 
          <td><strong><font size="1" face="Arial, Helvetica, sans-serif">Absolute:<%=a.chestPress[0]%></font></strong></td>
          <td><strong><font size="1" face="Arial, Helvetica, sans-serif">Relative:<%=a.chestPress[1]%></font></strong></td>
        </tr>
        <tr> 
          <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong>Category: <%=a.chestPress[2]%>
            </strong></font></td>
        </tr>
        <tr> 
          <td width="52%"><div align="left"><a href="viewFitnessAssess03.jsp"><img src="buttons/back.gif" width="35" height="19" border="0"></a></div></td>
          <td width="48%"><div align="right"><a href="viewClientProfile.jsp"><img src="buttons/finish.gif" width="43" height="19" border="0"></a></div></td>
        </tr>
      </table> </td>
