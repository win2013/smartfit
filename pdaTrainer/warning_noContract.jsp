    ...
    <td colspan="4" valign="top"> <table width="90%" border="0" align="center" cellpadding="2" cellspacing="0">
        ...
        <tr> 
          <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#FF0000">Warning:</font> 
            Client has no active contracts. See the appropriate staff member to 
            sign up for a new contract.</strong></font></td>
        </tr>
        <tr> 
          <td width="50%"> <div align="center"></div></td>
          <td width="50%"> <div align="center"><a href="memberSelect.jsp"><img src="buttons/ok.gif" width="23" height="19" border="0"></a></div></td>
        </tr>
      </table></td>
