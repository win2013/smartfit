    ...
    <td colspan="4" valign="top"> <table width="90%" border="0" align="center" cellpadding="2" cellspacing="0">
        ...
        <tr> 
          <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#FF0000">Warning:</font> 
            Client has no contracts with you. OK to use contract for other trainer?</strong></font></td>
        </tr>
        <tr> 
          <td width="50%"> <div align="center"><a href="memberSelect.jsp"><img src="buttons/no.gif" width="23" height="19" border="0"></a></div></td>
          <td width="50%"> <div align="center"><a href="beginSession.jsp"><img src="buttons/yes.gif" width="29" height="19" border="0"></a></div></td>
        </tr>
      </table></td>
