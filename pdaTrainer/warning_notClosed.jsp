...
<%
    ...
    WorkoutSession workoutSession = client.getWorkoutSession(Integer.parseInt(workoutSessionID));
    ...
    <td colspan="4" valign="top"> <table width="90%" border="0" align="center" cellpadding="2" cellspacing="0">
        ...
        <tr> 
          <td colspan="2"><font size="1" face="Arial, Helvetica, sans-serif"><strong><font color="#FF0000">Warning:</font> 
            Client has a workout session from <%=SMUtils.parseDateAndTime(workoutSession.getStartTime())%> that 
            has not been closed. Resume the session or sign out of the session.</strong></font></td>
        </tr>
        <tr> 
          <td width="50%"> <div align="center"><a href="warning_notClosed.jsp?action=resume&contractID=<%=contract.getID()%>&workoutSessionID=<%=workoutSession.getID()%>"><img border="0" src="buttons/resume.gif" width="47" height="19"></a></div></td>
          <td width="50%"> <div align="center"><a href="warning_notClosed.jsp?action=signout&contractID=<%=contract.getID()%>&workoutSessionID=<%=workoutSession.getID()%>"><img border="0" src="buttons/signOut.gif" width="55" height="19"></div></td>
        </tr>
      </table></td>
